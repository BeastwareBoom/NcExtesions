...
public class TextViewSpannableActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rootView = LayoutInflater.from(this).inflate(R.layout.activity_spannable, null);
        ...
        XmlResourceParser xppcolor = getResources().getXml(R.drawable.variable_style);
        try {
        ...
        XmlResourceParser xpplinkcolor = getResources().getXml(R.drawable.variable_style);
        try {
    ...
    public void snackBarClick(View view) {
        ...
        Snackbar
                .make(rootView, "点击弹出SnackBar", Snackbar.LENGTH_LONG)
                .setAction("Action", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(TextViewSpannableActivity.this, "点击了action", Toast.LENGTH_SHORT).show();
                    }
                })
                .show();
    }
